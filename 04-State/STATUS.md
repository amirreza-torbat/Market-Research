...
folder: 04-State
type: status
last_updated: 2026-09-14 12:40 (1405-06-23)
---
...
| فیلد | مقدار |
|------|-------|
| **وضعیت کلی** | 🟠 `review` (برای task-06 — QA نهایی PASS شد: ۴۹/۴۹) |
| **تسک فعلی** | `task-06` — اعتبارسنجی نهایی همه خروجی‌ها ✅ انجام شد (۴۹/۴۹ PASS، تلورانس ۰.۰۰۰۰۰۰۰۰۰۰٪) — منتظر review کاربر |
| **agent مسئول فعلی** | `qa-validator` (کار تمام) → قدم بعد: task-07/08 (خروجی‌ها) و task-09 (انتشار) |
...
| **قدم بعدی** | review گزارش QA (`04-State/qa-report.md`) → سپس `task-07/08` (خروجی‌ها) و `task-09` (انتشار) |
