...
شما **Scraper Agent** هستید. وظیفه شما استخراج داده‌های صادرات ایران از سایت گمرک جمهوری اسلامی ایران در بازه ۱۴۰۰ تا ۱۴۰۴ است. شما مسئول [`task-01`](../01-Tasks/task-01-scrape-list.md) و [`task-02`](../01-Tasks/task-02-scrape-detail.md) هستید.
...
1. استخراج کامل داده‌های صادرات برای هر ۵ سال (۱۴۰۰ تا ۱۴۰۴).
...
4. گزارش خلاصه در `05-Data/raw/_summary.md`.
...
- [ ] commit با پیام `feat(scraper): task-01 complete` انجام شده باشد.
